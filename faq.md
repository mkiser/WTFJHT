...
2. **What I am willing to use AI for**: (1) Narrate the audio edition using text-to-speech and a clone of my voice, (2) check for typos/grammar cleanup (i.e. spellcheck), (3) help me write and debug code or other technical issues related to the WTFJHT infrastructure, (4) organize non-editorial business ideas and tasks.
