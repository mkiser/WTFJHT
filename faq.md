...
<strong id="read-time-and-time-saved">How is "read time" and "time saved" calculated?</strong> For most adults reading on a screen, a common estimate of reading speed is about 200 words a minute. For time saved, I'm estimating the reading time it would have taken you to read one of the cited news articles behind each item. I measured the actual length of 105 news articles I've cited. While the median article length was 715 words, I thought that a more conservative estimate of 600 words per news article was appropriate. So, for each edition: multiply the number of cited items by 600, then divide by 200 to get the time it would take to read one full article per item. Then subtract the edition's own reading time: its word count divided by 200 words a minute. The difference is your time saved.
